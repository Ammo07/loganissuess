		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Log An Issue",
									"targetURL": "#ajloganissue-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ajloganissue-display": {
								"semanticObject": "ajloganissue",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=aj.loganissue",
									"url": sap.ui.require.toUrl("aj/loganissue")
								}
							}
						}
					}
